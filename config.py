...
if args.use_cfg:
    if args.dataset == 'collab':
        ...
        args.lr, args.weight_decay = 0.005, 0.002
        args.weight1, args.weight2, args.causal_ratio = 10.0, 10.0, 0.1
        args.hid_dim = 128
        args.dropout = 0.1
        args.spatial_drop = 0.5
        args.temporal_drop = 0.5
        args.structural_head_config, args.structural_layer_config = '8', '128'
        args.temporal_head_config, args.temporal_layer_config = '8', '128'
        args.warm_epoch = 0
        ...
        args.experiment_name = 'nc'
        args.lr, args.weight_decay = 0.005, 1e-5
        args.weight1, args.weight2, args.causal_ratio =  0.005, 0.005, 0.5
        args.hid_dim = 128
        args.warm_epoch = 0
        args.spatial_drop = 0.1
        args.temporal_drop = 0.1
        args.structural_head_config, args.structural_layer_config = '4,4', '128,128'
        args.temporal_head_config, args.temporal_layer_config = '4', '128'
        args.lin_bias = 1
    elif 'synthetic' in args.dataset:
        args.experiment_name = 'lp'
        
        if abs(args.P - 0.4) < 1e-6:
            print(f"Using optimized config for P=0.4")
            args.hid_dim = 64
            args.structural_layer_config = '64'
           
        elif abs(args.P - 0.6) < 1e-6:
           
            print(f"Using optimized config for P=0.6")
            args.lr = 0.0003
            args.weight_decay = 2e-06
            args.hid_dim = 32
            args.weight1 = 2.0
            args.weight2 = 1.0  
            args.causal_ratio = 0.5
            args.dropout = 0.3
            args.spatial_drop = 0.5
            args.temporal_drop = 0.3
            args.warm_epoch = 0
        ...
        elif abs(args.P - 0.8) < 1e-6:
            print(f"Using optimized config for P=0.8")
            args.lr = 0.0002
            ...
            print(f"Using default config for P={args.P}")
            args.lr, args.weight_decay = 0.005, 0.002
            args.weight1, args.weight2, args.causal_ratio =  2.0, 1.0, 0.5
            args.hid_dim = 128
            args.warm_epoch = 0
            args.spatial_drop = 0.2
            args.temporal_drop = 0.3
            args.structural_head_config, args.structural_layer_config = '4,4', '128,128'
            args.temporal_head_config, args.temporal_layer_config = '4', '128'
